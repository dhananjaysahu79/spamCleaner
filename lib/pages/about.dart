  ...
  Widget build(BuildContext context) {
    ...
    child:Scaffold(
      appBar: AppBar(
        ...
        title: Text("About",textScaleFactor: 0.8,style: TextStyle(color:Colors.black),),
      ),
      body: Column(
            ...
            flex: 1,
              child: Padding(
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    onTap:()async{
                          if (await canLaunch("https://github.com/dhananjaysahu79/spamCleaner"))
                            await  launch('https://github.com/dhananjaysahu79/spamCleaner');
                            else
                              throw "link not found";
                        },
                    child: Text("https://github.com/dhananjaysahu79/spamCleaner",style: TextStyle(color: Colors.blue),))
                ],
            ),
              ),
          )
